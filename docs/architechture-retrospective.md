...
## What has Changed
Nothing has really shifted in problem, key differentiator, or the POWERED BY line since the vision was first committed, however, we are focusing on ensuring accessibility for hard of hearing or Deaf users through TTS, and deferring STT, to ensure quality performance for TTS users. 
